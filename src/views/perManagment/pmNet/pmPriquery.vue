    ...
    export default {
      ...
      methods:{
        inquiry:function () {
          ...
          this.$http.post("vpc/describeNetworks",formData).then((res)=>{
            console.log(res);
            let result =res.data.NetworkSet[0];
            this.tableData =[];
            this.tableData.push(
              {key:'Cidr',value:result.Cidr},
              {key:"CreateTime",value:result.CreateTime},
              {key:'Gateway',value:result.Gateway},
              {key:"Id",value:result.Id},
              {key: "IpStart",value:result.IpStart},
              {key: "IpEnd",value:result.IpEnd},
              {key: "SubnetId",value:result.SubnetId},
